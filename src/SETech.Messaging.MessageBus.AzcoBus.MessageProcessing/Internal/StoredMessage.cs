...
/// <summary>Represents a message as stored in a backing queue.</summary>
public class StoredMessage
{
    ...
    /// <summary>Creates a <see cref="StoredMessage"/> from a <see cref="BusMessage"/> with extra properties specified.</summary>
    public static StoredMessage FromMessage(
        BusMessage message,
        long sequenceNumber,
